...
void cmd_help() {
    ...
    printfc(CLR1, "%c - use cheat slot 1 | ", CFG_CMD_USE_CHEAT_1);
    printfc(CLR1, "%c - use cheat slot 2\n", CFG_CMD_USE_CHEAT_2);
    printfc(CLR1, "%c - use cheat slot 3 | ", CFG_CMD_USE_CHEAT_3);
    printfc(CLR1, "%c - use cheat slot 4\n", CFG_CMD_USE_CHEAT_4);
    printfc(CLR1, "%c - use cheat slot 5 | ", CFG_CMD_USE_CHEAT_5);
    printfc(CLR1, "%c - use cheat slot 6\n", CFG_CMD_USE_CHEAT_6);
    printfc(CLR1, "%c - use cheat slot 7 | ", CFG_CMD_USE_CHEAT_7);
